...
$M=10$ with $N\ge1500$, by 0.08 }\DIFaddend to \DIFdelbegin \DIFdel{59\%, and PSO from about 13\% to 41\%,
so the methods that superficially match CA-WOA on carbon
become progressively less viable.
This shows that }\DIFdelend \DIFaddbegin \DIFadd{0.15 percentage points---reported here rather than omitted. Its variance is
...
(85.02--85.11\% at 1000 tasks). Only VCC and the metaheuristics are feasible everywhere. }\DIFaddend CA-WOA \DIFdelbegin \DIFdel{'s reliability is preserved as the workload grows, which is the property a production scheduler requires}\DIFdelend \DIFaddbegin \DIFadd{beats VCC in
...
\DIFadd{CA-WOA ranks first in all six configurations under each of the linear, cubic and piecewise power models---18 of
