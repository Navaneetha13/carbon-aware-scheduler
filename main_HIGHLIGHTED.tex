...
%DIF DEL main.tex.submitted-backup   Wed Aug 26 17:44:53 2026
%DIF ADD main.tex                    Mon Aug 31 15:15:36 2026
...
%DIF 25c25
%DIF < % -------------------- embedded bibliography (all 19 verified against DBLP/publisher/DOI) --------------------
%DIF -------
% ---- embedded bibliography: 31 entries, every DOI resolved against Crossref before use ---- %DIF > 
%DIF -------
...
%DIF 46a46-57
@article{abbasikhazaei2022energy,author={Abbasi-khazaei, Tahereh and Rezvani, Mohammad Hossein},title={Energy-aware and carbon-efficient VM placement optimization in cloud datacenters using evolutionary computing methods},journal={Soft Computing},year={2022},volume={26},number={19},pages={9287--9322},doi={10.1007/s00500-022-07245-y}} %DIF > 
@article{khodayarseresht2023energy,author={Khodayarseresht, Ehsan and Shameli-Sendi, Alireza and Fournier, Quentin and Dagenais, Michel},title={Energy and carbon-aware initial VM placement in geographically distributed cloud data centers},journal={Sustainable Computing: Informatics and Systems},year={2023},volume={38},pages={100888},doi={10.1016/j.suscom.2023.100888}} %DIF > 
@article{miao2024energy,author={Miao, Zicong and Liu, Lei},title={Energy and carbon-aware distributed machine learning tasks scheduling scheme for the multi-renewable energy-based edge-cloud continuum},journal={Science and Technology for Energy Transition},year={2024},volume={79},pages={82},doi={10.2516/stet/2024076}} %DIF > 
@article{danach2026carbon,author={Danach, Kassem},title={Carbon-aware scheduling in cloud computing operations: A multi-objective optimisation approach},journal={IET Smart Grid},year={2026},doi={10.1049/stg2.70056}} %DIF > 
@article{ruparel2026carbon,author={Ruparel, Shivam},title={Carbon-aware scheduling and distributionally robust optimization for cloud systems: forecasting, battery storage, and adaptive ambiguity refinement},journal={Journal of Cloud Computing},year={2026},volume={15},doi={10.1186/s13677-026-00904-7}} %DIF > 
@inproceedings{moore2025sustainable,author={Moore, Jacob},title={Sustainable carbon-aware and water-efficient LLM scheduling in geo-distributed cloud datacenters},booktitle={Proceedings of the Great Lakes Symposium on VLSI (GLSVLSI '25)},year={2025},doi={10.1145/3716368.3735301}} %DIF > 
@article{zhang2024ewoa,author={Zhang, Yanfeng and Wang, Jiawei},title={Enhanced Whale Optimization Algorithm for task scheduling in cloud computing environments},journal={Journal of Engineering and Applied Science},year={2024},volume={71},pages={121},doi={10.1186/s44147-024-00445-3}} %DIF > 
@article{feng2025gwo,author={Feng, Hao and Li, Haoyu and Liu, Yuming and Cao, Kun and Zhou, Xiumin},title={A novel virtual machine placement algorithm based on grey wolf optimization},journal={Journal of Cloud Computing},year={2025},volume={14},pages={7},doi={10.1186/s13677-025-00730-3}} %DIF > 
@article{madhusudhan2023hho,author={Madhusudhan, H. S. and Satish Kumar, T. and Gupta, Punit and McArdle, Gavin},title={A Harris Hawk Optimisation system for energy and resource efficient virtual machine placement in cloud data centers},journal={PLOS ONE},year={2023},volume={18},number={8},pages={e0289156},doi={10.1371/journal.pone.0289156}} %DIF > 
@article{kumar2023eeoa,author={Santhosh Kumar, M. and Karri, Ganesh Reddy},title={EEOA: Cost and energy efficient task scheduling in a cloud-fog framework},journal={Sensors},year={2023},volume={23},number={5},pages={2445},doi={10.3390/s23052445}} %DIF > 
@article{wang2024load,author={Wang, Fangzong and Nishtar, Zuhaib},title={Real-time load forecasting and adaptive control in smart grids using a hybrid neuro-fuzzy approach},journal={Energies},year={2024},volume={17},number={11},pages={2539},doi={10.3390/en17112539}} %DIF > 
@article{wang2024levelling,author={Wang, Fangzong and Nishtar, Zuhaib},title={Innovative load forecasting models and intelligent control strategy for enhancing distributed load levelling techniques in resilient smart grids},journal={Electronics},year={2024},volume={13},number={17},pages={3552},doi={10.3390/electronics13173552}} %DIF > 
%DIF -------
\end{filecontents*}
...
\DIFdelbegin \DIFdel{research
investigates whether }\DIFdelend \DIFaddbegin \DIFadd{report studies }\DIFaddend carbon-aware \DIFdelbegin \DIFdel{scheduling can be improved by applying the Whale Optimization Algorithm,
which has not previously been used }\DIFdelend \DIFaddbegin \DIFadd{temporal shifting under realistic host-capacity constraints and asks a narrower
question than is usual: not whether a metaheuristic can schedule }\DIFaddend for carbon, \DIFdelbegin \DIFdel{to the problem, and by making the scheduler predictive. A
}\DIFdelend \DIFaddbegin \DIFadd{but \emph{when} search is needed
...
}\DIFaddend carbon-aware \DIFdelbegin \DIFdel{variant, CA-WOA, is proposed: it enhances Whale Optimization with carbon-aware seeding and a
fitness function that penalises deadline and capacity
violations, and it is paired with an ensemble
carbon-intensity forecaster combining a CNN-LSTM, a GRU and gradient boosting. The approach is evaluated by
simulation on real data (}\DIFdelend \DIFaddbegin \DIFadd{greedy schedule. Evaluated on }\DIFaddend the Google Cluster Trace and the \DIFdelbegin \DIFdel{UK National Grid }\DIFdelend \DIFaddbegin \DIFadd{NASA-iPSC trace against
}\DIFaddend carbon-intensity \DIFdelbegin \DIFdel{signal)
against
a FIFO baseline and six standard metaheuristics, over multiple seeds and workload sizes from 50 to 300
tasks. CA-WOA achieves the highest carbon reduction of any SLA-safe method (up to about 87\%) while never violating a deadline, }\DIFdelend \DIFaddbegin \DIFadd{signals from the United Kingdom, the Republic of Ireland, Northern Ireland and two United
States regions, with 30 independent seeds and task counts from 500 to 3000 on 10 }\DIFaddend and \DIFdelbegin \DIFdel{the ensemble forecaster reduces prediction error by roughly 12\% over a baseline LSTM. Unlike the aggressive baselines, whose deadline violations grow with load, CA-WOA scales safely, making it a
practical }\DIFdelend \DIFaddbegin \DIFadd{20 hosts, seeding
...
schedules and outperforms the virtual-capacity-curve policy of a deployed production }\DIFaddend carbon-aware \DIFdelbegin \DIFdel{scheduler}\DIFdelend \DIFaddbegin \DIFadd{scheduler in
...
minimum active-host constraint, the advantage of seeding disappears}\DIFaddend .
\end{abstract}
...
\DIFaddbegin \vspace{4pt}
\noindent\DIFadd{\textbf{Abbreviations.}
...
problem; and although metaheuristics are the standard tool for NP-hard scheduling, \DIFdelbegin \DIFdel{the Whale Optimization
Algorithm (WOA), an effective and widely used optimiser, has yet to be applied to carbon-aware
scheduling }\DIFdelend \DIFaddbegin \DIFadd{they are typically initialised at
...
variable}\DIFaddend . Moreover, carbon forecasts, when used at all, are typically applied reactively rather than being
coupled into the scheduler\DIFaddbegin \DIFadd{, and the conditions under which temporal shifting is worth doing at all are seldom
...
\item Implement the scheduler and an ensemble carbon-intensity forecaster on real data\DIFdelbegin \DIFdel{(}\DIFdelend \DIFaddbegin \DIFadd{: the }\DIFaddend Google Cluster
Trace and \DIFdelbegin \DIFdel{UK National Grid carbon intensity)}\DIFdelend \DIFaddbegin \DIFadd{NASA-iPSC workloads, and half-hourly carbon-intensity series for five grid regions}\DIFaddend .
\item Evaluate CA-WOA against \DIFdelbegin \DIFdel{baselines and metaheuristics on }\DIFdelend \DIFaddbegin \DIFadd{deterministic baselines, five standard metaheuristics and two published
schedulers on feasibility, }\DIFaddend carbon reduction, SLA violations, energy, utilisation and scalability from \DIFdelbegin \DIFdel{50 to
300 tasks}\DIFdelend \DIFaddbegin \DIFadd{500 to
3000 tasks, over 30 independent seeds and five real grid carbon-intensity traces}\DIFaddend .
\end{enumerate}

The \DIFdelbegin \DIFdel{main contribution is CA-WOA, the first application of Whale Optimization to }\DIFdelend \DIFaddbegin \DIFadd{contributions are five:
}\begin{enumerate}
\item \DIFadd{A \textbf{regime analysis} separating the cases in which }\DIFaddend carbon-aware scheduling \DIFdelbegin \DIFdel{,
enhanced with }\DIFdelend \DIFaddbegin \DIFadd{is trivial (separable,
...
}\item \DIFadd{\textbf{Carbon-aware seeding}, shown to transfer across six population-based optimisers and proved to be
bounded above by the quality of the schedule it seeds.
}\item \DIFadd{An \textbf{isolating ablation} showing that the benefit comes from the carbon information itself rather
than from a more sophisticated sampling scheme.
}\item \DIFadd{A \textbf{feasibility-first evaluation} across five real grid regions, showing that the standard greedy
}\DIFaddend carbon-aware \DIFdelbegin \DIFdel{seeding and an SLA- and overload-penalised fitness function,
together with a predictive ensemble forecaster and a scalability study on real workload and
carbon traces.
As a limitation
}\DIFdelend \DIFaddbegin \DIFadd{heuristic does not produce valid schedules once host capacity binds.
}\item \DIFadd{A \textbf{reproducibility artefact}: 29 experiments reporting one row per configuration, method and
...
\DIFadd{As limitations }\DIFaddend stated upfront, the evaluation is a simulation driven by real \DIFdelbegin \DIFdel{data }\DIFdelend \DIFaddbegin \DIFadd{traces }\DIFaddend rather than a deployment on
physical hardware, and \DIFdelbegin \DIFdel{it uses a single national grid signal}\DIFdelend \DIFaddbegin \DIFadd{the advantage of the proposed seeding vanishes both on grids with little diurnal carbon
variation and under an enforced minimum active-host constraint}\DIFaddend ; these are revisited in
...
no reproducible artefact for job-level scheduling research. \DIFaddbegin \DIFadd{More recent work extends carbon-aware scheduling to
large language model serving across geo-distributed datacentres, jointly considering carbon and water
footprints \cite{moore2025sustainable}. }\DIFaddend None of these works casts carbon-aware scheduling as a metaheuristic
search problem \DIFaddbegin \DIFadd{in which the initial population carries domain knowledge}\DIFaddend .
...
values by violating service-level agreements (SLAs). \DIFdelbegin \DIFdel{Critically, although WOA }\DIFdelend \DIFaddbegin \DIFadd{WOA in particular }\DIFaddend has been applied to \DIFdelbegin \DIFdel{energy- and
cost-aware scheduling , to the best of our knowledge it has not }\DIFdelend \DIFaddbegin \DIFadd{cloud task scheduling in enhanced form
\cite{zhang2024ewoa}, and related swarm methods have }\DIFaddend been applied to \DIFdelbegin \DIFdel{\emph{carbon}-aware scheduling,
and its random population initialisation wastes function evaluations that a domain-informed seeding strategy
could exploit. }\DIFdelend \DIFaddbegin \DIFadd{energy- and carbon-aware virtual-machine
...
outperform plain recurrent networks. \DIFaddbegin \DIFadd{Forecasting of grid-side quantities more
...
carbon-specific seasonal baselines rather than against load-forecasting benchmarks. }\DIFaddend What remains
...
%DIFDELCMD < \caption{Comparison of representative energy-/carbon-aware scheduling and forecasting studies.
%DIFDELCMD < (Y = yes, N = no, P = partial; ``Real'' = evaluated on a real workload and/or grid trace; ``Fcst'' = coupled to a forecaster.)}
%DIFDELCMD < \label{tab:related}
%DIFDELCMD < \begin{tabular}{@{}p{2.35cm}cp{1.9cm}ccccc@{}}
%DIFDELCMD < \toprule
%DIFDELCMD < Study & Yr & Technique & Obj. & Carbon & SLA & Real & Fcst \\
%DIFDELCMD < \midrule
%DIFDELCMD < Beloglazov \& Buyya \cite{beloglazov2012optimal} & 2012 & MBFD heuristic & Energy & N & P & N & N \\
%DIFDELCMD < Beloglazov et al. \cite{beloglazov2012energy} & 2012 & Threshold heuristic & Energy & N & Y & N & N \\
%DIFDELCMD < Goiri et al. \cite{goiri2011greenslot} & 2011 & GreenSlot heuristic & Green E & P & Y & N & Y \\
%DIFDELCMD < Wiesner et al. \cite{wiesner2021lets} & 2021 & Temporal shifting & Carbon & Y & Y & Y & N \\
%DIFDELCMD < Radovanovi\'c et al. \cite{radovanovic2023carbon} & 2023 & Load-shaping (VCC) & Carbon & Y & Y & Y & Y \\
%DIFDELCMD < Dodge et al. \cite{dodge2022measuring} & 2022 & Measurement study & Carbon & Y & -- & Y & N \\
%DIFDELCMD < Kalra \& Singh \cite{kalra2015review} & 2015 & Survey (metaheur.) & Mixed & N & P & P & N \\
%DIFDELCMD < Mirjalili \& Lewis \cite{mirjalili2016whale} & 2016 & WOA & Generic & N & N & -- & N \\
%DIFDELCMD < Mirjalili et al. \cite{mirjalili2014grey} & 2014 & GWO & Generic & N & N & -- & N \\
%DIFDELCMD < Heidari et al. \cite{heidari2019harris} & 2019 & HHO & Generic & N & N & -- & N \\
%DIFDELCMD < Leerbeck et al. \cite{leerbeck2020short} & 2020 & ML forecast & CI fcst & Y & -- & Y & Y \\
%DIFDELCMD < Maji et al. \cite{maji2022carboncast} & 2022 & CNN-LSTM (CarbonCast) & CI fcst & Y & -- & Y & Y \\
%DIFDELCMD < \midrule
%DIFDELCMD < \textbf{This work} & \textbf{2026} & \textbf{CA-WOA + ensemble} & \textbf{Carbon} & \textbf{Y} & \textbf{Y} & \textbf{Y} & \textbf{Y} \\
%DIFDELCMD < \bottomrule
%DIFDELCMD < \end{tabular}
%DIFDELCMD < \end{table}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \begin{table}[H]\centering
\footnotesize
...
optimise energy, cost or makespan, \DIFdelbegin \DIFdel{have not been applied to carbon}\DIFdelend \DIFaddbegin \DIFadd{are initialised at random regardless of available domain knowledge}\DIFaddend , and
...
\DIFdelbegin \DIFdel{No existing work combines }\DIFdelend \DIFaddbegin \DIFadd{The gap is therefore not a missing algorithm but a missing \emph{question}. Carbon-aware metaheuristic
...
What is absent is }\DIFaddend (i) a \DIFdelbegin \DIFdel{metaheuristic that applies Whale Optimization directly to carbon minimisation, }\DIFdelend \DIFaddbegin \DIFadd{characterisation of \emph{when} population-based search is necessary at all, as
opposed to a greedy rule being sufficient or even provably optimal; }\DIFaddend (ii) \DIFdelbegin \DIFdel{carbon-aware seeding with an SLA- }\DIFdelend \DIFaddbegin \DIFadd{treatment of population
initialisation as a design variable carrying domain knowledge, evaluated across optimisers rather than
demonstrated for one; }\DIFaddend and \DIFdelbegin \DIFdel{overload-penalised fitness function to protect deadlines, and }\DIFdelend (iii) \DIFdelbegin \DIFdel{a predictive ensemble forecaster, evaluated on real workload and carbon traces across a range of workload
sizes}\DIFdelend \DIFaddbegin \DIFadd{feasibility-first evaluation, in which a schedule that exceeds host capacity is
disqualified rather than credited with the carbon it appears to save}\DIFaddend . This gap motivates the research question
...
deadline equal to its earliest start plus its duration plus a fixed slack. \DIFaddbegin \DIFadd{Because the Google trace spans only 1.54~h of
arrivals, tasks are sampled at an even stride across all 52}{\DIFadd{,}}\DIFadd{057 usable records so that the real submission
...
\DIFaddend Grid carbon intensity is obtained \DIFdelbegin \DIFdel{from the UK National Grid Carbon Intensity API as a }\DIFdelend \DIFaddbegin \DIFadd{for \emph{five} regions as }\DIFaddend half-hourly series in
gCO\textsubscript{2}/kWh, \DIFdelbegin \DIFdel{and a
}\DIFdelend \DIFaddbegin \DIFadd{so that no conclusion depends on a single grid
...
A United Kingdom }\DIFaddend time-of-use \DIFdelbegin \DIFdel{electricity }\DIFdelend tariff is applied \DIFdelbegin \DIFdel{for cost . For workload forecasting, the NASA-iPSC job-arrival trace
from the Parallel Workloads Archive is used}\DIFdelend \DIFaddbegin \DIFadd{unchanged to every region as a cost proxy, not as a claim about
local pricing}\DIFaddend . Time is discretised into 30-minute slots aligned with the carbon series.

\DIFaddbegin \begin{table}[H]\centering\small
...
\DIFaddend \subsection{Energy and carbon model}
Server power is modelled with the \DIFdelbegin \DIFdel{widely used SPECpower linear approximation }\DIFdelend \DIFaddbegin \DIFadd{linear approximation widely used in the consolidation literature}\DIFaddend , in which
a host at CPU utilisation $u$ draws $P(u)=P_{\text{idle}}+(P_{\text{max}}-P_{\text{idle}})\,u$, with
$P_{\text{idle}}=100$~W and $P_{\text{max}}=250$~W \cite{beloglazov2012energy}. \DIFdelbegin \DIFdel{Two }\DIFdelend \DIFaddbegin \DIFadd{These endpoints correspond to
...
\DIFadd{Two placement }\DIFaddend models are evaluated. In the \emph{temporal} model, energy is accumulated per task, isolating
...
energy. \DIFaddbegin \DIFadd{Three extensions are used to test realism, each reducing to the published model at its default
...
\DIFaddend The carbon of a slot is its energy multiplied by the carbon intensity of that slot\DIFdelbegin \DIFdel{, }\DIFdelend \DIFaddbegin \DIFadd{. \textbf{Monetary cost is
...
}\DIFaddend and \DIFdelbegin \DIFdel{cost is its energy multiplied by the tariff}\DIFdelend \DIFaddbegin \DIFadd{0.935~GBP without altering any ranking}\DIFaddend . It is \DIFaddbegin \DIFadd{retained for
completeness and the reader should not interpret it as a co-optimised objective. It is }\DIFaddend emphasised that this is
a simulation driven by real traces and \DIFdelbegin \DIFdel{a documented power model}\DIFdelend \DIFaddbegin \DIFadd{documented power models}\DIFaddend , not a measurement on physical hardware.

\subsection{Evaluation metrics and design}
Each schedule is assessed on\DIFdelbegin \DIFdel{five measures}\DIFdelend : carbon reduction \DIFaddbegin \DIFadd{(\%) }\DIFaddend relative to a \DIFdelbegin \DIFdel{First-In-First-Out }\DIFdelend \DIFaddbegin \DIFadd{first-in-first-out }\DIFaddend (FIFO) baseline,
SLA-violation percentage (tasks finishing after their deadline) \DIFaddbegin \DIFadd{together with the absolute violation count}\DIFaddend ,
energy (kWh), \DIFdelbegin \DIFdel{server utilisation and
makespan ; the
capacity model additionally reports overload.
}\DIFdelend \DIFaddbegin \DIFadd{emissions (kgCO\textsubscript{2}), host utilisation (\%), makespan (h) and overload (\% of
...
\DIFaddend Because metaheuristics are stochastic, every algorithm is run over \DIFdelbegin \DIFdel{multiple random seeds and results are reported as mean~$\pm$~standard deviation . }\DIFdelend \DIFaddbegin \DIFadd{\textbf{30 independent seeds}, and every
...
\DIFaddend To assess scalability, the full comparison is repeated at task counts of \DIFaddbegin \DIFadd{500, 1000, 1500, 2000, 2500 and 3000
on 10 and 20 hosts. Runtime, peak memory and the number of function evaluations (NFE) are recorded per run,
and convergence curves are retained per epoch. Runtime and memory are additionally reported at }\DIFaddend 50, 100, 200
and 300 \DIFdelbegin \DIFdel{, with five seeds at
each size.
}\DIFdelend \DIFaddbegin \DIFadd{tasks for comparability with smaller-scale studies.
}

\DIFaddend The carbon forecaster is evaluated on a held-out final 20\% of the \DIFdelbegin \DIFdel{carbon series using mean absolute
error (MAE), with a 48-slot (24-hour)look-back and
multivariate inputs}\DIFdelend \DIFaddbegin \DIFadd{series with direct multi-step prediction at
...
results are reported as mean~$\pm$~standard deviation, because single-run figures did not reproduce}\DIFaddend . All
experiments use fixed seeds \DIFdelbegin \DIFdel{for
reproducibility and are implemented in Python using }\DIFdelend \DIFaddbegin \DIFadd{and recorded dependency versions (}\DIFaddend Mealpy 3.0.3, \DIFdelbegin \DIFdel{TensorFlow/Keras }\DIFdelend \DIFaddbegin \DIFadd{NumPy 2.5.2, SciPy 1.16.3,
pandas 3.0.5, TensorFlow 2.21 with operation-level determinism enabled, }\DIFaddend and scikit-learn \DIFaddbegin \DIFadd{1.9). Mealpy is
...
\DIFaddbegin \subsection{\DIFadd{Exact formulation and when search is necessary}}\label{sec:milp}
\DIFadd{The scheduling problem is a mixed-integer linear program. Let $x_{is}\in\{0,1\}$ be 1 if task $i$ starts in
...
\end{align}
\DIFadd{Deadlines are enforced structurally by the domain $T_i$, which is what the repair decoding implements.
}

\vspace{2pt}\noindent\DIFadd{\textbf{Lemma 1 (separability).} \emph{In the temporal model the objective is separable
...
\vspace{2pt}\noindent \DIFadd{This is a proof rather than an observation, and it explains an otherwise puzzling
...
\DIFadd{Two further regimes follow. Under \emph{consolidation}, per-slot energy contains the term
...
\DIFadd{An exact solve is not used as a head-to-head baseline. With deadline slack of 8 slots, $|T_i|\le 9$, so
$N=3000$ yields up to 27}{\DIFadd{,}}\DIFadd{000 binaries and 144 capacity rows---tractable, but an exact solver has no anytime
...
\subsection{\DIFadd{Convergence analysis}}\label{sec:conv}
\DIFadd{The decoded search space is finite: each task takes an integer start in a window of at most
...
\vspace{2pt}\noindent\DIFadd{\textbf{Theorem 1.} \emph{Because the optimiser is elitist, $F^{*}_t=F(x^{*}_t)$ is
...
\vspace{2pt}\noindent \DIFadd{This is all that elitism buys. The standard sufficient condition for convergence to the
...
\vspace{2pt}\noindent\DIFadd{\textbf{Corollary 1 (initialisation changes the limit).} \emph{For a chain meeting the
...
\vspace{2pt}\noindent\DIFadd{\textbf{Corollary 2 (the seed is a bound).} \emph{If $P_0$ contains a schedule $u$ then
...
\vspace{2pt}\noindent\DIFadd{\textbf{Proposition 1.} \emph{In the temporal model CA-WOA attains the global optimum in
one epoch}, by Lemma 1 and Corollary 2 together---the seeded schedule is already optimal.
}

\DIFaddend \subsection{Host-capacity consolidation}
...
The real datasets are ingested directly: the Google Cluster Trace task-event files \DIFaddbegin \DIFadd{and the NASA-iPSC log }\DIFaddend are
parsed to extract task submission times, durations and CPU requests, and the \DIFdelbegin \DIFdel{UK National Grid }\DIFdelend \DIFaddbegin \DIFadd{five regional }\DIFaddend carbon-intensity
series \DIFdelbegin \DIFdel{is }\DIFdelend \DIFaddbegin \DIFadd{listed in Table~\ref{tab:regions} are }\DIFaddend loaded as the per-slot carbon signal. The principal outputs are
the trained forecasting models, the per-method scheduling results (\DIFaddbegin \DIFadd{feasibility, }\DIFaddend carbon, SLA, energy,
utilisation, makespan and overload), the \DIFdelbegin \DIFdel{multi-seed }\DIFdelend \DIFaddbegin \DIFadd{30-seed }\DIFaddend scalability results across \DIFaddbegin \DIFadd{500--3000 tasks on 10 and 20
hosts, the runtime and memory figures at }\DIFaddend 50--300 tasks, and the figures presented in
Section~\ref{sec:eval}. All results are regenerated by re-running
...
All scheduling experiments use the parameters in Table~\ref{tab:config}\DIFdelbegin \DIFdel{, and every algorithm , CA-WOA
and the baselines alike, uses the }\DIFdelend \DIFaddbegin \DIFadd{. Every algorithm is configured with
the }\DIFaddend same population size, \DIFdelbegin \DIFdel{evolution count and random seed, so
differences reflect the algorithms rather than their budgets.
The number of hosts is not fixed a priori
but \emph{derived} from the workload: $M=\lceil\text{peak FIFO demand}\rceil$ (equal to five hosts of
unit capacity for the 60-task set), so each method is given exactly the capacity the baseline needs}\DIFdelend \DIFaddbegin \DIFadd{epoch count and seed, but \textbf{the resulting evaluation budgets are not
identical} and this must be stated plainly: measured over all runs, HHO consumes 8}{\DIFadd{,}}\DIFadd{908 objective evaluations
on average (minimum 8}{\DIFadd{,}}\DIFadd{698, maximum 9}{\DIFadd{,}}\DIFadd{136) against exactly 4}{\DIFadd{,}}\DIFadd{840 for WOA, GWO, PSO, DE and GA. HHO's
...
\DIFadd{Host counts are fixed at $M\in\{10,20\}$ so that capacity is a controlled variable. In the earlier design $M$
...
makes the host count meaningful}\DIFaddend .
...
\DIFdelbegin %DIFDELCMD < \begin{table}[H]\centering \footnotesize
%DIFDELCMD < \caption{Common experimental configuration.}\label{tab:config}
%DIFDELCMD < \begin{tabular}{@{}ll@{}}
%DIFDELCMD < \toprule Parameter & Value \\ \midrule
%DIFDELCMD < Population size & 40 (capacity model), 50 (temporal model) \\
%DIFDELCMD < Evolution count (epochs) & 120 (capacity model), 150 (temporal model) \\
%DIFDELCMD < Independent seeds & 5 (robustness/scalability); base seed 42 \\
%DIFDELCMD < Tasks $N$ & 60 (main); \{50, 100, 200, 300\} (scalability) \\
%DIFDELCMD < Hosts $M$ (VMs) & derived $=\lceil$peak demand$\rceil=5$; capacity $C=1$ \\
%DIFDELCMD < Time horizon & 144 half-hour slots (3 days) \\
%DIFDELCMD < Deadline slack / max deferral & 8 / 24 slots \\
%DIFDELCMD < Fitness weights $(\alpha,\beta,\gamma)$ & $(0.4, 0.3, 0.3)$, sum $=1$ \\
%DIFDELCMD < Power model & $P_{\text{idle}}=100$~W, $P_{\text{max}}=250$~W, slot $0.5$~h \\
%DIFDELCMD < \bottomrule
%DIFDELCMD < \end{tabular}
%DIFDELCMD < \end{table}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \begin{table}[H]\centering \footnotesize
...
Independent seeds & 30 (seeds 1--30) \\
...
\DIFdelbegin %DIFDELCMD < \begin{table}[H]\centering \footnotesize
%DIFDELCMD < \caption{Per-algorithm control parameters (Mealpy 3.0.3 defaults; identical across all runs).}\label{tab:hyper}
%DIFDELCMD < \begin{tabular}{@{}ll@{}}
%DIFDELCMD < \toprule Algorithm & Control parameters \\ \midrule
%DIFDELCMD < CA-WOA (proposed) & WOA operators; $\approx\!1/3$ population carbon-seeded \\
%DIFDELCMD < WOA & $a$: linear from 2 to 0, spiral $b=1$, switch $p=0.5$ \\
%DIFDELCMD < GWO & $a$: linear from 2 to 0 \\
%DIFDELCMD < PSO & $c_1=c_2=2.05$, inertia $w=0.4$ \\
%DIFDELCMD < DE & scaling $F=0.1$, crossover $CR=0.9$, rand/1/bin \\
%DIFDELCMD < HHO & escaping energy $E_0\in[-1,1]$ (default) \\
%DIFDELCMD < GA & $p_c=0.95$, $p_m=0.025$, tournament sel., uniform crossover \\
%DIFDELCMD < \bottomrule
%DIFDELCMD < \end{tabular}
%DIFDELCMD < \end{table}
%DIFDELCMD < %%%
...
The first experiment \DIFdelbegin \DIFdel{isolates the benefit of carbon-aware \emph{timing} by scheduling a fixed set of real
Google tasks under the temporal model, comparing }\DIFdelend \DIFaddbegin \DIFadd{compares }\DIFaddend CA-WOA against the FIFO baseline and the \DIFdelbegin \DIFdel{standard
metaheuristics}\DIFdelend \DIFaddbegin \DIFadd{five standard metaheuristics at the
largest workload, 3000 tasks on 10 hosts, over 30 seeds}\DIFaddend . Fig.~\ref{fig:temporal} reports carbon reduction and
\DIFdelbegin \DIFdel{SLA violations. }\DIFdelend \DIFaddbegin \DIFadd{deadline violations, and Table~\ref{tab:alg} gives the figures.
}

\DIFaddend CA-WOA achieves \DIFdelbegin \DIFdel{an
11.3\% carbon reductionwhile keeping SLA violations at 0}\DIFdelend \DIFaddbegin \DIFadd{the highest carbon reduction, $87.58 \pm 0.10$\%, while holding deadline violations to
0.13}\DIFaddend \%. Standard WOA \DIFdelbegin \DIFdel{, by contrast, achieves only 1.2\% ,
confirming that the }\DIFdelend \DIFaddbegin \DIFadd{reaches 87.15\% with 0.57\% violations, so }\DIFaddend carbon-aware seeding \DIFdelbegin \DIFdel{, rather than the WOA operators alone, drives the
improvement. Several
algorithms reach a numerically higher carbon reduction, with }\DIFdelend \DIFaddbegin \DIFadd{contributes $+0.44$
percentage points here---a small margin, but consistent across seeds and statistically significant, and the
regime analysis in Section~\ref{sec:milp} explains why it cannot be large: without a binding capacity
constraint the problem is close to separable.
}

\DIFadd{The important contrast is on the second axis. }\DIFaddend PSO, DE and GA \DIFdelbegin \DIFdel{reaching 19--20\%, but only by
violating deadlines heavily (20.0\% }\DIFdelend \DIFaddbegin \DIFadd{reach \emph{lower} carbon reduction than CA-WOA
\emph{and} miss 61.5\%, 54.0\% and 44.3\% of deadlines respectively}\DIFaddend , \DIFdelbegin \DIFdel{21.7\% and 56.7\% of tasks respectively), which makes them unusable in
practice; GWO likewise trades a 6.7\% SLA violation for its 10.7\% reduction. Among the methods that hold SLA
violations at exactly zero, CA-WOA is
the strongest, marginally ahead of HHO (11.1\% ) and far ahead of
standard WOA.
}\DIFdelend \DIFaddbegin \DIFadd{so they are worse on both measures at
once rather than trading one for the other. GWO misses 7.0\% of deadlines for 87.11\% carbon. Only HHO is
competitive on both, at 87.37\% with 0.001\% violations---but it does so with roughly 1.84$\times$ the
evaluation budget (Section~\ref{sec:config}), so that comparison is not like-for-like.
}

\begin{table}[H]\centering\footnotesize
\caption{Algorithm comparison at 3000 tasks on 10 hosts, mean $\pm$ standard deviation over 30 seeds. The
aggressive optimisers are worse on both axes simultaneously; HHO is competitive but on a larger evaluation
budget.}\label{tab:alg}
\begin{tabular}{lrr}
\toprule
Method & Carbon reduction (\%) & SLA violations (\%) \\
\midrule
\textbf{CA-WOA} & $\mathbf{87.58 \pm 0.10}$ & $\mathbf{0.13 \pm 0.11}$ \\
HHO             & $87.37 \pm 0.10$ & $0.00 \pm 0.01$ \\
WOA             & $87.15 \pm 0.08$ & $0.57 \pm 0.54$ \\
GWO             & $87.11 \pm 0.08$ & $7.02 \pm 0.54$ \\
GA              & $86.81 \pm 0.11$ & $44.28 \pm 0.48$ \\
PSO             & $86.70 \pm 0.10$ & $61.48 \pm 0.57$ \\
DE              & $86.69 \pm 0.09$ & $54.04 \pm 1.65$ \\
\bottomrule
\end{tabular}
\end{table}
\DIFaddend \begin{figure}[H]\centering
\includegraphics[width=\linewidth]{fig_temporal_comparison.png}
\caption{\DIFdelbeginFL \DIFdelFL{CA-WOA versus the FIFO baseline and standard metaheuristics }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Algorithm comparison at 3000 tasks on 10 hosts }\DIFaddendFL under the \DIFdelbeginFL \DIFdelFL{temporal }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{published }\DIFaddendFL model\DIFaddbeginFL \DIFaddFL{, 30 seeds}\DIFaddendFL : \DIFaddbeginFL \DIFaddFL{(a) }\DIFaddendFL carbon
reduction \DIFaddbeginFL \DIFaddFL{against the naive FIFO baseline and }\DIFaddendFL (\DIFdelbeginFL \DIFdelFL{left}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{b}\DIFaddendFL ) \DIFdelbeginFL \DIFdelFL{and SLA }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{deadline }\DIFaddendFL violations\DIFaddbeginFL \DIFaddFL{. Error bars are 95\% confidence
intervals. Note the truncated vertical axis in }\DIFaddendFL (\DIFdelbeginFL \DIFdelFL{right}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{a}\DIFaddendFL )\DIFaddbeginFL \DIFaddFL{: the full spread across methods is only 0.87 percentage
points, so the visual separation overstates the practical difference in carbon, whereas the differences in (b)
are of a different order entirely}\DIFaddendFL . \DIFaddbeginFL \DIFaddFL{The methods that appear competitive on carbon are the ones missing
deadlines.}\DIFaddendFL }\label{fig:temporal}
\end{figure}
...
summarise the results. \DIFdelbegin \DIFdel{Most of the reductionnow comes from consolidation, since the energy-aware baseline alonereaches 80.5\%,
with }\DIFdelend \DIFaddbegin \DIFadd{\textbf{The headline figure must be decomposed, because most of it is not attributable to the proposed
method.} Of CA-WOA's 83.25\% reduction, 80.50 percentage points are delivered by consolidation alone,
}\DIFaddend carbon-aware timing \DIFdelbegin \DIFdel{adding a few further percentage points. }\DIFdelend \DIFaddbegin \DIFadd{contributes a further 2.06, and }\DIFaddend CA-WOA \DIFdelbegin \DIFdel{again gives the best
result, an }\DIFdelend \DIFaddbegin \DIFadd{adds 0.69 over the carbon-aware greedy heuristic.
Reporting }\DIFaddend 83.25\% \DIFdelbegin \DIFdel{carbon reduction with 0\% SLA violations and the highest server utilisation (84.0\%) ,
narrowly ahead of the }\DIFdelend \DIFaddbegin \DIFadd{as the contribution of a metaheuristic would be misleading; the honest statement is that
...
\DIFadd{The comparison also changes once feasibility is enforced. Under the published model, host capacity is not a
constraint at all, so methods are free to exceed the available hosts. Treating capacity as a feasibility
constraint (Section~\ref{sec:feas}) reverses the apparent ranking: the }\DIFaddend carbon-aware greedy heuristic \DIFdelbegin \DIFdel{(82.6\% ) and HHO (82.3\% ). }\DIFdelend \DIFaddbegin \DIFadd{reaches
...
result. }\DIFaddend The aggressive optimisers \DIFdelbegin \DIFdel{that
looked competitive on carbon }\DIFdelend (PSO, DE, GA) again incur substantial SLA \DIFdelbegin \DIFdel{violations and lower utilisation,
reinforcing that CA-WOA's advantage lies in achieving top carbon performance \emph{without} sacrificing
deadlines .
}%DIFDELCMD < \begin{table}[H]\centering
%DIFDELCMD < \caption{Capacity-model comparison (real Google trace + UK carbon).}\label{tab:capacity}
%DIFDELCMD < \begin{tabular}{lccc}
%DIFDELCMD < \toprule Method & Carbon red.\% & SLA\% & Util.\% \\ \midrule
%DIFDELCMD < Energy-aware (consolidation) & 80.5 & 0.0 & 75.2 \\
%DIFDELCMD < Carbon-aware greedy & 82.6 & 0.0 & 75.2 \\
%DIFDELCMD < HHO & 82.3 & 0.0 & 83.1 \\
%DIFDELCMD < \textbf{CA-WOA} & \textbf{83.25} & \textbf{0.0} & \textbf{84.0} \\ \bottomrule
%DIFDELCMD < \end{tabular}
%DIFDELCMD < \end{table}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \DIFadd{violations---33\% to 64\% of
...
\caption{\DIFdelbeginFL \DIFdelFL{Host-capacity model across all methods}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Capacity as a feasibility constraint, 10 hosts, 30 seeds. (a) Overload as a percentage of demanded
load}\DIFaddendFL : \DIFdelbeginFL \DIFdelFL{carbon reduction}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{any value above zero is an infeasible schedule}\DIFaddendFL , \DIFdelbeginFL \DIFdelFL{SLA violations }\DIFdelendFL and \DIFdelbeginFL \DIFdelFL{server utilisation }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{the heuristics degrade as load rises while every
population-based method stays at zero. }\DIFaddendFL (\DIFdelbeginFL \DIFdelFL{CA-WOA highlighted}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{b}\DIFaddendFL ) \DIFaddbeginFL \DIFaddFL{Carbon reduction among feasible schedules only}\DIFaddendFL . \DIFaddbeginFL \DIFaddFL{Error bars are 95\%
confidence intervals.}\DIFaddendFL }\label{fig:capacityfig}
\end{figure}

\subsection{Scalability across task counts (\DIFdelbegin \DIFdel{50--300}\DIFdelend \DIFaddbegin \DIFadd{500--3000}\DIFaddend )}
\DIFdelbegin \DIFdel{A key question for practical adoption is whether the advantage persists as the workload grows.
}\DIFdelend Fig.~\ref{fig:scale} repeats the \DIFdelbegin \DIFdel{capacity-model comparison at 50, 100, 200 }\DIFdelend \DIFaddbegin \DIFadd{comparison at 500 to 3000 tasks on 10 }\DIFaddend and \DIFdelbegin \DIFdel{300 tasks , averaged over five
seeds. }\DIFdelend \DIFaddbegin \DIFadd{20 hosts, over 30 seeds. Under the
published (uncapacitated) model }\DIFaddend CA-WOA \DIFdelbegin \DIFdel{remains the best method at every task count, its carbonreduction rising from
82.0\% at 50 tasks to 86.6\% at 300 tasks , while its SLA violations stay at exactly 0\% throughout . The contrast with the }\DIFdelend \DIFaddbegin \DIFadd{is the best metaheuristic in \textbf{12 of 12} configurations. The
contrast with the }\DIFaddend deadline-violating \DIFdelbegin \DIFdel{optimisers sharpens with scale: the SLA violations of GA, PSO and DE \emph{grow} as the workload increases: GA rises from roughly 47\% }\DIFdelend \DIFaddbegin \DIFadd{optimisers sharpens with scale, exactly as originally claimed: mean SLA
...
\caption{\DIFaddFL{Scalability: carbon reduction (left) and SLA violations (right) versus task count (500--3000), mean
over 30 seeds with 95\% confidence intervals, for $M=10$ and $M=20$.}}\label{fig:scale}
\end{figure}

\subsection{\DIFadd{Capacity as a feasibility constraint}}\label{sec:feas}
\DIFadd{This is the decisive experiment. Energy is charged on the full demanded load---so overloading is never
...
\DIFadd{Among feasible schedules CA-WOA is best in 9 of 12 configurations. It is beaten by GA in three cells, all at
$M=10$ with $N\ge1500$, by 0.08 }\DIFaddend to \DIFdelbegin \DIFdel{59\%, and PSO from about 13\%}\DIFdelend \DIFaddbegin \DIFadd{0.15 percentage points---reported here rather than omitted. Its variance is
also higher than its rivals' (standard deviation up to 0.33 against GA's 0.03), so it finds better schedules
less consistently.
}

\subsection{\DIFadd{Comparison with published schedulers}}\label{sec:modern}
\DIFadd{Two published policies are reimplemented in the same simulator, using no fitness function and no
...
\subsection{\DIFadd{Ablation}}\label{sec:ablation}
\DIFadd{Table~\ref{tab:ablation} separates the contributions. Two results matter most. First, carbon-aware seeding
...
but \emph{no carbon data} is statistically indistinguishable from uniform random ($+0.003$ }\DIFaddend to \DIFdelbegin \DIFdel{41\% , so the methods that superficially match }\DIFdelend \DIFaddbegin \DIFadd{$+0.027$ points,
...
\subsection{\DIFadd{Fitness-weight sensitivity}}\label{sec:weights}
\DIFadd{Eleven weight combinations were evaluated. Read on carbon alone the results are misleading: $\alpha=1.0$
...
\subsection{\DIFadd{Power models}}\label{sec:power}
\DIFaddend CA-WOA \DIFdelbegin \DIFdel{on carbon
become progressively less viable. This shows that }\DIFdelend \DIFaddbegin \DIFadd{ranks first in all six configurations under each of the linear, cubic and piecewise power models---18 of
...
\subsection{\DIFadd{Minimum active-host constraint}}\label{sec:mmin}
\DIFadd{A data centre cannot scale to zero. With a workload-determined warm pool powered across the operating window,
deferral becomes costly because shifting work extends that window. This single constraint \textbf{reverses} the
comparison with the greedy heuristic: without it }\DIFaddend CA-WOA \DIFaddbegin \DIFadd{wins 3 of 12 configurations, with it 12 of 12 (mean
...
\subsection{\DIFadd{Heterogeneous fleets and startup overheads}}\label{sec:het}
\DIFadd{Three fleets were evaluated: uniform; \emph{mixed}, where newer hosts are larger and more efficient; and
...
\subsection{\DIFadd{Multiple carbon regions}}\label{sec:regions}
\DIFadd{Across five real grids the carbon-aware greedy rule is feasible in only 25--42\% of three-day windows, whereas
...
\DIFadd{The boundary of the method is found in the Mid-Atlantic region, whose carbon intensity varies only
...
\DIFadd{Fig.~\ref{fig:regions} plots the seeding gain against each grid's carbon variability. The least variable grid
...
\caption{\DIFaddFL{Seeding gain (CA-WOA minus standard WOA) against grid carbon variability, 1500 tasks, six real
...
\subsection{\DIFadd{Multiple workload subsets and a second trace}}\label{sec:workloads}
\DIFadd{Reviewers asked whether the results depend on the particular workload sample drawn.
Two checks were run. First, four \emph{disjoint} subsets of the Google trace were
scheduled independently. CA-WOA}\DIFaddend 's \DIFdelbegin \DIFdel{reliability is
preserved as the workload grows, }\DIFdelend \DIFaddbegin \DIFadd{carbon reduction varies little across them:
standard deviation 0.13 to 0.59 percentage points depending on configuration, with
a full range of 86.47 to 89.22\,\% across all subsets and task counts. The result is
therefore not an artefact of one sample.
}

\DIFadd{Second, the NASA-iPSC log was used as an independent workload with a genuine 92-day
arrival process, rather than the 1.54-hour arrival span of the Google trace.
Absolute carbon reductions are markedly lower there---61.6 to 67.6\,\% against 84 to
89\,\% on Google---because a real multi-day arrival spread offers far less
opportunity to shift work into a green slot. This is the more realistic figure and
we report it as such.
}

\DIFadd{The ranking, however, is unchanged: CA-WOA is best in all six NASA configurations
(Table~\ref{tab:nasa}). The SLA contrast is also far starker than on the Google
trace. Averaged per configuration, PSO misses 52.5 to 63.6\,\% of deadlines, DE 46.3
to 56.9\,\% and GA 21.2 to 49.9\,\%, while CA-WOA stays between 0.00 and 0.41\,\%.
The aggressive optimisers are therefore worse on both axes simultaneously on a
realistic arrival process, }\DIFaddend which is the \DIFdelbegin \DIFdel{property a production scheduler requires. }\DIFdelend \DIFaddbegin \DIFadd{pattern the submitted version claimed but
could not demonstrate at that scale.
}

\begin{table}[H]\centering\small
\caption{NASA-iPSC trace, mean over 10 seeds per configuration. Carbon reductions
are lower than on the Google trace because a real 92-day arrival process offers
less shifting opportunity; the ranking is unchanged and the SLA gap widens.}
\label{tab:nasa}
\begin{tabular}{lrr}
\toprule
Method & Carbon reduction (\%) & SLA violations (\%) \\
\midrule
\textbf{CA-WOA} & \textbf{67.58} & \textbf{0.16} \\
GWO             & 65.95 & 6.48 \\
HHO             & 65.23 & 0.02 \\
WOA             & 65.03 & 0.27 \\
GA              & 63.53 & 35.85 \\
...
\subsection{\DIFadd{Computational cost and convergence}}\label{sec:cost}
\DIFadd{Runtime scales linearly in task count. WOA is the cheapest search in the study (1.54~s and 0.99~MB at 500
...
\DIFadd{Convergence curves show the seeding acting exactly as intended: CA-WOA begins at roughly half the fitness of
...
\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=\linewidth]{fig_scalability.png}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=\linewidth]{fig_convergence.png}
\DIFaddendFL \caption{\DIFdelbeginFL \DIFdelFL{Scalability: carbon reduction (left) and SLA violations (right) versus task count (50--300)}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Convergence at 3000 tasks on 10 hosts}\DIFaddendFL , \DIFdelbeginFL \DIFdelFL{mean over five }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{10 }\DIFaddendFL seeds\DIFaddbeginFL \DIFaddFL{, shaded band one standard deviation}\DIFaddendFL . \DIFaddbeginFL \DIFaddFL{Carbon-aware
...
budget ends.}\DIFaddendFL }\DIFdelbeginFL %DIFDELCMD < \label{fig:scale}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \label{fig:conv}
...
of 3.39~gCO\textsubscript{2}/kWh \DIFdelbegin \DIFdel{, compared with }\DIFdelend \DIFaddbegin \DIFadd{against }\DIFaddend 3.87 for the baseline LSTM\DIFdelbegin \DIFdel{, a reduction }\DIFdelend \DIFaddbegin \DIFadd{. \textbf{That single-run comparison did
...
12-hour horizon, where the ensemble achieves MAE 26.09 $\pm$ 0.48~gCO\textsubscript{2}/kWh against 37.03 for a
...
}\DIFaddend of roughly 12\% \DIFdelbegin \DIFdel{,
as shown in }\DIFdelend \DIFaddbegin \DIFadd{is therefore withdrawn. }\DIFaddend Fig.~\ref{fig:forecast} \DIFdelbegin \DIFdel{, where the ensemble tracks the actual curve more closely.
}\DIFdelend \DIFaddbegin \DIFadd{reports the accuracy of every model against
horizon, together with the three naive baselines.
}

\DIFaddend Coupling the forecast into the scheduler makes it predictive rather than reactive\DIFdelbegin \DIFdel{: scheduling
against the forecast yields 0.795}\DIFdelend \DIFaddbegin \DIFadd{, and the effect is measured
at an identical optimisation budget of 4}{\DIFadd{,}}\DIFadd{840 objective evaluations. At 1000 tasks on 10 hosts, scheduling
against a 12-hour-ahead forecast yields 1.070}\DIFaddend ~kg~CO\textsubscript{2} \DIFdelbegin \DIFdel{versus 0.831}\DIFdelend \DIFaddbegin \DIFadd{against 1.224}\DIFaddend ~kg for \DIFaddbegin \DIFadd{purely }\DIFaddend reactive
scheduling on \DIFdelbegin \DIFdel{current intensity. A }\DIFdelend \DIFaddbegin \DIFadd{the current intensity, while a }\DIFaddend perfect-foresight oracle reaches \DIFdelbegin \DIFdel{0.785~kg, so the forecast-driven scheduler captures 78}\DIFdelend \DIFaddbegin \DIFadd{1.024~kg. The forecast therefore
recovers 76.8}\DIFaddend \% of the \DIFdelbegin \DIFdel{saving }\DIFdelend \DIFaddbegin \DIFadd{advantage }\DIFaddend that perfect knowledge of the future would \DIFdelbegin \DIFdel{allow.
}\DIFdelend \DIFaddbegin \DIFadd{confer; across the three
configurations tested the range is 73--89\%.
}

\DIFadd{\textbf{An earlier version of this analysis reported 78\%, computed from a different and smaller
configuration, and a companion figure quoted 99--100\%.} The latter divided the two total carbon reductions,
both of which are dominated by the consolidation baseline, and would therefore have flattered any forecast
regardless of its accuracy. The quantity reported here is the fraction of the \emph{advantage over reactive
scheduling} that the forecast recovers, which is the meaningful comparison.
}

\paragraph{\DIFadd{Sensitivity to forecast error.}} \DIFadd{Because a forecast-driven scheduler is only as good as its
forecast, controlled Gaussian error was injected into the carbon signal, the schedule was chosen on the
\emph{noisy} signal, and the result was then scored against the \emph{true} signal. Ten seeds were run at each
error level. Table~\ref{tab:degrade} reports the outcome at 3000 tasks on 10 hosts.
}

\DIFadd{The degradation is gradual rather than sharp. A realised MAE of 9.9~gCO\textsubscript{2}/kWh---already
noticeably worse than the 12-hour ensemble achieves in practice---costs only 0.33 percentage points of carbon
reduction, and even a severe 71.6~gCO\textsubscript{2}/kWh error, roughly two thirds of the mean UK intensity,
costs 1.55 points. Scheduling on an imperfect forecast is therefore robust: the method does not require an
accurate forecast so much as a forecast that ranks slots roughly correctly, which is a much weaker
requirement. At the smallest error levels the noisy schedule occasionally scores marginally \emph{above} the
perfect-information schedule (a gap of $-0.11$ points at 1000 tasks), which is a sampling artefact of the
greedy tie-breaking rather than a real gain, and is reported as measured.
}

\begin{table}[H]\centering\small
\caption{Sensitivity of carbon reduction to forecast error at 3000 tasks on 10 hosts, mean over 10 seeds. The
schedule is chosen on a noisy carbon signal and scored on the true one; the gap is the loss relative to
scheduling with perfect information.}\label{tab:degrade}
\begin{tabular}{rrrr}
\toprule
Realised MAE (gCO\textsubscript{2}/kWh) & Carbon reduction (\%) & s.d. & Gap (points) \\
\midrule
0.0  & 89.40 & 0.00 & 0.00 \\
5.0  & 89.25 & 0.10 & 0.15 \\
9.9  & 89.07 & 0.19 & 0.33 \\
19.8 & 88.85 & 0.30 & 0.55 \\
38.9 & 88.21 & 0.47 & 1.19 \\
71.6 & 87.85 & 0.42 & 1.55 \\
\bottomrule
\end{tabular}
\end{table}

\DIFaddend For completeness, a Transformer forecaster was also tested but performed markedly worse (MAE
9.27\DIFaddbegin \DIFadd{~gCO\textsubscript{2}/kWh against 3.51 for gradient boosting on the same single-run protocol}\DIFaddend ), consistent
with reports that attention models underperform on smooth, \DIFdelbegin \DIFdel{small }\DIFdelend \DIFaddbegin \DIFadd{short }\DIFaddend time series; this negative result is
reported rather than omitted.
\begin{figure}[H]\centering
\includegraphics[width=\linewidth]{fig_forecast_comparison.png}
\caption{\DIFdelbeginFL \DIFdelFL{Held-out carbon-intensity forecast: the actual series compared }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Carbon-intensity forecasting }\DIFaddendFL with \DIFdelbeginFL \DIFdelFL{the baseline LSTM }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{direct multi-step prediction, mean of five repeats, error bars one
standard deviation. (a) MAE against forecast horizon for every model }\DIFaddendFL and the \DIFdelbeginFL \DIFdelFL{adopted }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{three naive baselines. (b) The
12-hour horizon in detail. The }\DIFaddendFL ensemble \DIFaddbeginFL \DIFaddFL{leads at horizons up to 12~h; CNN-LSTM is the weakest learned model at
every horizon tested}\DIFaddendFL .}\label{fig:forecast}
\end{figure}

\subsection{Discussion}
\DIFdelbegin \DIFdel{Taken together, the }\DIFdelend \DIFaddbegin \DIFadd{The }\DIFaddend results answer the research question\DIFdelbegin \DIFdel{affirmatively: CA-WOA reduces carbon more than the
baseline and the standard metaheuristics while holding SLA violations at zero}\DIFdelend \DIFaddbegin \DIFadd{, but more narrowly and more usefully than a simple affirmative. The
...
the fitness weights cannot matter. The right question is \emph{when} search is needed}\DIFaddend , and the \DIFdelbegin \DIFdel{advantage is stable
across seeds and workload sizes. The findings align with and }\DIFdelend \DIFaddbegin \DIFadd{answer is that
...
\DIFadd{Within that regime the contribution is carbon-aware seeding, and its value is that it transfers: it improves
...
\DIFadd{These findings }\DIFaddend extend the literature reviewed in Section~\ref{sec:related}. They confirm the value of temporal
shifting \DIFdelbegin \DIFdel{reported by Wiesner et al.
}\DIFdelend \cite{wiesner2021lets} and of consolidation \DIFdelbegin \DIFdel{established by Beloglazov et al. \cite{beloglazov2012energy} , but
show that }\DIFdelend \DIFaddbegin \DIFadd{\cite{beloglazov2012energy} and show }\DIFaddend the two are
complementary\DIFdelbegin \DIFdel{and can be combined within a single metaheuristic search; and they support
the finding that ensembles outperform single forecasters, echoing the hybrid-model advantage reported for
CarbonCast \cite{maji2022carboncast}.
The principal strength of }\DIFdelend \DIFaddbegin \DIFadd{, but they also qualify both: consolidation accounts for 80.50 of the 83.25 percentage points
...
\subsection{\DIFadd{Limitations}}\label{sec:limits}
\DIFadd{The following are stated explicitly because several of them qualify the contribution.
}\begin{enumerate}
\item \DIFadd{\textbf{The seeding advantage disappears under a minimum active-host constraint.} With a warm pool
enforced, }\DIFaddend CA-WOA \DIFdelbegin \DIFdel{is its combination of strong carbon
performance with strict SLA compliance, a trade-off the aggressive baselines fail.
The main limitations, that the evaluation is a simulation on real traces rather than a physical deployment, that it uses a
single
national grid signal, and that neural-network results vary slightly between runs, are addressed in the conclusion. }\DIFdelend \DIFaddbegin \DIFadd{beats the greedy heuristic in 12 of 12 configurations but exceeds \emph{plain} WOA by only
0.04 points, significant in 1 of 12 cells (Section~\ref{sec:mmin}).
}\item \DIFadd{\textbf{The method does not help on a flat carbon grid.} In the Mid-Atlantic region (1.78$\times$ diurnal
variation) CA-WOA loses by 0.13 points (Section~\ref{sec:regions}).
}\item \DIFadd{\textbf{CA-WOA loses to GA in 3 of 12 capacity-constrained cells}, all at $M=10$, by 0.08--0.15 points.
}\item \DIFadd{\textbf{CA-WOA has higher run-to-run variance} than its rivals (standard deviation up to 0.97 against
0.11--0.21 under some power models).
}\item \DIFadd{\textbf{Evaluation budgets are not equal.} HHO receives approximately 8}{\DIFadd{,}}\DIFadd{908 objective evaluations
against 4}{\DIFadd{,}}\DIFadd{840 for the others.
}\item \DIFadd{\textbf{GA and GWO had not converged} at the 120-epoch budget, so their results are lower bounds.
}\item \DIFadd{\textbf{The earlier GA baseline performed no search.} \texttt{GA.OriginalGA} in Mealpy 3.0.3 evaluates
only its initial population; \texttt{GA.BaseGA} is used here.
}\item \DIFadd{\textbf{The forecasting headline did not reproduce.} The improvement over a baseline LSTM is
approximately 7\%, not 12\%, and the CNN-LSTM component is the weakest model at every horizon.
}\item \DIFadd{\textbf{The evaluation is a simulation} driven by real traces and documented power models, not a
measurement on physical hardware; startup overheads and heterogeneity are modelled parametrically rather than
measured.
}\item \DIFadd{\textbf{Cost is reported but not optimised}, and the United Kingdom tariff is applied to all regions as
...
overload-penalised fitness function; the scheduler and an ensemble carbon forecaster were implemented on \DIFdelbegin \DIFdel{real
Google and UK National Grid data}\DIFdelend \DIFaddbegin \DIFadd{the
real Google Cluster and NASA-iPSC traces and five regional grid carbon-intensity series}\DIFaddend ; and the approach was
evaluated against \DIFdelbegin \DIFdel{baselines and metaheuristics across
workload sizes}\DIFdelend \DIFaddbegin \DIFadd{deterministic baselines, five standard metaheuristics and two published schedulers across
task counts from 500 to 3000 on 10 and 20 hosts, over 30 independent seeds}\DIFaddend .

The key findings are \DIFdelbegin \DIFdel{that CA-WOA achieves the highest carbon reduction among SLA-safe methods, up to about
83\% under the capacity model,
rising to roughly 87\%at 300 tasks, while never violating a deadline; that its }\DIFdelend \DIFaddbegin \DIFadd{four. First, }\DIFaddend carbon-aware \DIFaddbegin \DIFadd{temporal shifting is only a hard problem once host capacity
...
Third, in that regime carbon-aware }\DIFaddend seeding \DIFdelbegin \DIFdel{lifts standard WOA from a 1.2\% to an 11.3\% reduction in the temporal model; and that the adopted ensemble forecaster cuts prediction error by about 12\% relative to a baseline LSTM and lets the scheduler capture 78}\DIFdelend \DIFaddbegin \DIFadd{improves six different optimisers in 59 of 60
...
12-hour-ahead ensemble forecast captures 73--89}\DIFaddend \% of the \DIFdelbegin \DIFdel{oracle's possible saving.
The methods that rival CA-WOA on carbon do so only by
violating an increasing fraction of deadlines as load grows, so CA-WOA is the only approach that scales safely}\DIFdelend \DIFaddbegin \DIFadd{advantage that perfect foresight holds over
reactive scheduling.
}

\DIFadd{The boundaries of the approach are equally definite and are reported in Section~\ref{sec:limits}: on a grid
...
should \emph{not} be deployed is part of the contribution}\DIFaddend .

\DIFdelbegin \DIFdel{The main limitations are that the study is a simulation on real traces rather than a physical deployment and
that it considers a single national grid. Meaningful future work therefore includes deploying the scheduler on
a real cluster (for example, }\DIFdelend \DIFaddbegin \DIFadd{Future work follows from these boundaries rather than from generic extension. Solving the mixed-integer
...
dominate moving it in time. Deployment }\DIFaddend as a carbon-aware Kubernetes scheduler \DIFdelbegin \DIFdel{); extending it to multiple regions so that
jobs can be shifted geographically as well as temporally toward cleaner grids; integrating on-site solar
generation and battery storage into the scheduling decision; and replacing the fixed fitness weights with a
learned or reinforcement-learning-based policy. These directions build directly on the reproducible artefact
developed here}\DIFdelend \DIFaddbegin \DIFadd{would replace the parametric
...
\DIFadd{All data are public. Workload traces: Google Cluster Trace 2011 \cite{reiss2011google} and the NASA-iPSC log
...
}\url{https://doi.org/10.5281/zenodo.22125797}\DIFadd{. Dependencies are recorded (Mealpy 3.0.3, NumPy 2.5.2, SciPy 1.16.3)
...
is computed, and it should be run first}\DIFaddend .
