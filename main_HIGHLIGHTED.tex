...
%DIF ADD main.tex                    Thu Aug 27 15:48:31 2026
...
}\cite{abbasikhazaei2022energy, khodayarseresht2023energy, miao2024energy, danach2026carbon, ruparel2026carbon}\DIFadd{,
...
footprints }\cite{moore2025sustainable}\DIFadd{. }\DIFaddend None of these works casts carbon-aware scheduling as a metaheuristic
...
}\cite{zhang2024ewoa}\DIFadd{, and related swarm methods have }\DIFaddend been applied to \DIFdelbegin \DIFdel{\emph{carbon}-aware scheduling,
...
placement }\cite{feng2025gwo, madhusudhan2023hho, kumar2023eeoa, abbasikhazaei2022energy}\DIFadd{. What these share is
...
}\cite{wang2024load, wang2024levelling}\DIFadd{. Carbon intensity is a related but distinct target, since it depends on
...
\DIFaddbeginFL \DIFaddFL{Abbasi-khazaei \& Rezvani }\cite{abbasikhazaei2022energy} & \DIFaddFL{2022 }& \DIFaddFL{Evolutionary VM placement }& \DIFaddFL{Carbon }& \DIFaddFL{Y }& \DIFaddFL{Y }& \DIFaddFL{Y }& \DIFaddFL{N }\\
\DIFaddFL{Khodayarseresht et al. }\cite{khodayarseresht2023energy} & \DIFaddFL{2023 }& \DIFaddFL{Geo-distributed placement }& \DIFaddFL{Carbon }& \DIFaddFL{Y }& \DIFaddFL{P }& \DIFaddFL{Y }& \DIFaddFL{N }\\
\DIFaddFL{Madhusudhan et al. }\cite{madhusudhan2023hho} & \DIFaddFL{2023 }& \DIFaddFL{HHO VM placement }& \DIFaddFL{Energy }& \DIFaddFL{N }& \DIFaddFL{P }& \DIFaddFL{Y }& \DIFaddFL{N }\\
\DIFaddFL{Zhang \& Wang }\cite{zhang2024ewoa} & \DIFaddFL{2024 }& \DIFaddFL{Enhanced WOA }& \DIFaddFL{Mixed }& \DIFaddFL{N }& \DIFaddFL{P }& \DIFaddFL{Y }& \DIFaddFL{N }\\
\DIFaddFL{Miao et al. }\cite{miao2024energy} & \DIFaddFL{2024 }& \DIFaddFL{Edge-cloud continuum }& \DIFaddFL{Carbon }& \DIFaddFL{Y }& \DIFaddFL{Y }& \DIFaddFL{Y }& \DIFaddFL{P }\\
\DIFaddFL{Feng et al. }\cite{feng2025gwo} & \DIFaddFL{2025 }& \DIFaddFL{GWO VM placement }& \DIFaddFL{Energy }& \DIFaddFL{N }& \DIFaddFL{P }& \DIFaddFL{Y }& \DIFaddFL{N }\\
\DIFaddFL{Danach }\cite{danach2026carbon} & \DIFaddFL{2026 }& \DIFaddFL{Multi-objective opt. }& \DIFaddFL{Carbon }& \DIFaddFL{Y }& \DIFaddFL{Y }& \DIFaddFL{Y }& \DIFaddFL{P }\\
\DIFaddFL{Ruparel }\cite{ruparel2026carbon} & \DIFaddFL{2026 }& \DIFaddFL{Robust opt. + storage }& \DIFaddFL{Carbon }& \DIFaddFL{Y }& \DIFaddFL{Y }& \DIFaddFL{Y }& \DIFaddFL{Y }\\
\DIFaddendFL \midrule
...
scheduling is established }\cite{abbasikhazaei2022energy, khodayarseresht2023energy, miao2024energy}\DIFadd{, and
recent work extends it to multi-objective and robust formulations }\cite{danach2026carbon, ruparel2026carbon}\DIFadd{.
...
\caption{\DIFaddFL{Carbon-intensity traces. Variability is the ratio of maximum to minimum intensity over the
111-day record and determines how much temporal shifting can achieve.}}\label{tab:regions}
\begin{tabular}{lrrrr}
\toprule
\DIFaddFL{Region }& \DIFaddFL{Slots }& \DIFaddFL{Mean (gCO\textsubscript{2}/kWh) }& \DIFaddFL{Range }& \DIFaddFL{Variability }\\
\midrule
\DIFaddFL{United Kingdom       }& \DIFaddFL{5}{\DIFaddFL{,}}\DIFaddFL{329 }& \DIFaddFL{111.9 }& \DIFaddFL{20--246  }& \DIFaddFL{12.30$\times$ }\\
\DIFaddFL{Northern Ireland     }& \DIFaddFL{4}{\DIFaddFL{,}}\DIFaddFL{990 }& \DIFaddFL{197.9 }& \DIFaddFL{47--444  }& \DIFaddFL{9.46$\times$ }\\
\DIFaddFL{United States (CAL)  }& \DIFaddFL{5}{\DIFaddFL{,}}\DIFaddFL{376 }& \DIFaddFL{173.0 }& \DIFaddFL{65--422  }& \DIFaddFL{6.49$\times$ }\\
\DIFaddFL{Republic of Ireland  }& \DIFaddFL{5}{\DIFaddFL{,}}\DIFaddFL{374 }& \DIFaddFL{168.6 }& \DIFaddFL{77--336  }& \DIFaddFL{4.36$\times$ }\\
\DIFaddFL{United States (MIDA) }& \DIFaddFL{5}{\DIFaddFL{,}}\DIFaddFL{376 }& \DIFaddFL{333.5 }& \DIFaddFL{235--418 }& \DIFaddFL{1.78$\times$ }\\
\bottomrule
\end{tabular}
\end{table}
...
\DIFadd{\min\ }& \DIFadd{\textstyle\sum_i\sum_{s\in T_i} c_{is}\,x_{is} \label{eq:milp}}\\
\DIFadd{\text{s.t.}\ }& \DIFadd{\textstyle\sum_{s\in T_i} x_{is}=1 }&& \DIFadd{\forall i \label{eq:assign}}\\
& \DIFadd{\textstyle\sum_i\sum_{s:\,s\le k<s+p_i} u_i\,x_{is}\ \le\ M\!\cdot\!C }&& \DIFadd{\forall k \label{eq:cap}
}\end{align}
...
Population size & 40 \DIFdelbeginFL \DIFdelFL{(capacity model), 50 (temporal model) }\DIFdelendFL \\
Evolution count (epochs) & 120 \DIFdelbeginFL \DIFdelFL{(capacity model),150 (temporal model}\DIFdelendFL \DIFaddbeginFL \\
\DIFaddFL{Objective evaluations per run }& \DIFaddFL{4}{\DIFaddFL{,}}\DIFaddFL{840 (8}{\DIFaddFL{,}}\DIFaddFL{908 for HHO; see text}\DIFaddendFL ) \\
Independent seeds & \DIFdelbeginFL \DIFdelFL{5 (robustness/scalability) ; base seed 42 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{30 (seeds 1--30) }\DIFaddendFL \\
Tasks $N$ & \DIFdelbeginFL \DIFdelFL{60 (main); \{50, 100, 200, 300\} (scalability) }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{\{500, 1000, 1500, 2000, 2500, 3000\} }\DIFaddendFL \\
Hosts $M$ \DIFdelbeginFL \DIFdelFL{(VMs) }\DIFdelendFL & \DIFdelbeginFL \DIFdelFL{derived $=\lceil$peak demand$\rceil=5$}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{\{10, 20\}}\DIFaddendFL ; capacity $C=1$ \DIFaddbeginFL \DIFaddFL{per host }\DIFaddendFL \\
...
Power \DIFdelbeginFL \DIFdelFL{model }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{models }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{$P_{\text{idle}}=100$~W }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{linear, cubic, piecewise; all 100~W at $u{=}0$, 250~W at $u{=}1$ }\\
\DIFaddFL{Carbon regions }& \DIFaddFL{UK, IE, NI, US-CAL}\DIFaddendFL , \DIFdelbeginFL \DIFdelFL{$P_{\text{max}}=250$~W , slot $0.5$}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{US-MIDA }\\
\DIFaddFL{Slot length }& \DIFaddFL{0.5}\DIFaddendFL ~h \\
\bottomrule
\end{tabular}
\end{table}

\begin{table}[H]\centering \footnotesize
\caption{Per-algorithm control parameters (Mealpy 3.0.3 defaults; identical across all runs). \DIFaddbeginFL \DIFaddFL{Note the GA
implementation: \texttt{GA.OriginalGA} in Mealpy 3.0.3 evaluates only its initial population---40 objective
evaluations rather than 4}{\DIFaddFL{,}}\DIFaddFL{840---and therefore performs no search. \texttt{GA.BaseGA} is used instead, and
the defect is quantified in Section~\ref{sec:eval}.}\DIFaddendFL }\label{tab:hyper}
\begin{tabular}{@{}ll@{}}
...
GA \DIFaddbeginFL \DIFaddFL{(\texttt{BaseGA}) }\DIFaddendFL & $p_c=0.95$, $p_m=0.025$, tournament sel., uniform crossover \\
\bottomrule
\end{tabular}
\end{table}
...
deadlines }\DIFdelend \DIFaddbegin \DIFadd{violations---33\% to 64\% of
deadlines missed---so they are worse on both axes simultaneously}\DIFaddend .
\begin{table}[H]\centering
\caption{Capacity-model comparison (real Google trace\DIFdelbeginFL \DIFdelFL{+ }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{, }\DIFaddendFL UK carbon)\DIFaddbeginFL \DIFaddFL{, with the reduction decomposed by
mechanism}\DIFaddendFL . \DIFaddbeginFL \DIFaddFL{Consolidation accounts for 80.50 of the 83.25 percentage points.}\DIFaddendFL }\label{tab:capacity}
\DIFdelbeginFL %DIFDELCMD < \begin{tabular}{lccc}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \begin{tabular}{lcccc}
\DIFaddendFL \toprule Method & Carbon red.\% & SLA\% & Util.\% \DIFaddbeginFL & \DIFaddFL{Attributable to }\DIFaddendFL \\ \midrule
\DIFaddbeginFL \DIFaddFL{Naive FIFO (reference)       }& \DIFaddFL{0.00           }& \DIFaddFL{0.0           }& \DIFaddFL{--             }& \DIFaddFL{-- }\\
\DIFaddendFL Energy-aware (consolidation) & \DIFdelbeginFL \DIFdelFL{80.5 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{80.50          }\DIFaddendFL & 0.0           & 75.2           \DIFaddbeginFL & \DIFaddFL{consolidation }\DIFaddendFL \\
Carbon-aware greedy          & \DIFdelbeginFL \DIFdelFL{82.6 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{82.56          }\DIFaddendFL & 0.0           & 75.2           \DIFaddbeginFL & \DIFaddFL{$+2.06$ timing }\DIFaddendFL \\
HHO                          & \DIFdelbeginFL \DIFdelFL{82.3 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{82.30          }\DIFaddendFL & 0.0           & 83.1           \DIFaddbeginFL & \DIFaddFL{search }\DIFaddendFL \\
\textbf{CA-WOA}              & \textbf{83.25} & \textbf{0.0}  & \textbf{84.0}  \DIFaddbeginFL & \DIFaddFL{$+0.69$ over greedy }\DIFaddendFL \\
\bottomrule
\end{tabular}
\end{table}
\begin{figure}[H]\centering
...
\begin{table}[H]\centering\footnotesize
\caption{\DIFaddFL{Overload as a percentage of demanded load, $M=10$. Any non-zero value is an infeasible schedule. All
six metaheuristics, and Google's VCC policy, remain at 0.00 throughout.}}\label{tab:feas}
\begin{tabular}{lrrrrrr}
\toprule
\DIFaddFL{Method }& \DIFaddFL{500 }& \DIFaddFL{1000 }& \DIFaddFL{1500 }& \DIFaddFL{2000 }& \DIFaddFL{2500 }& \DIFaddFL{3000 }\\ \midrule
\DIFaddFL{FIFO / consolidation      }& \DIFaddFL{0.00 }& \DIFaddFL{0.99 }& \DIFaddFL{8.97  }& \DIFaddFL{18.22 }& \DIFaddFL{24.80 }& \DIFaddFL{28.54 }\\
\DIFaddFL{Threshold (Wait Awhile)   }& \DIFaddFL{0.00 }& \DIFaddFL{0.99 }& \DIFaddFL{8.97  }& \DIFaddFL{18.22 }& \DIFaddFL{24.80 }& \DIFaddFL{28.54 }\\
\DIFaddFL{Carbon-aware greedy       }& \DIFaddFL{0.00 }& \DIFaddFL{7.14 }& \DIFaddFL{24.69 }& \DIFaddFL{34.70 }& \DIFaddFL{41.36 }& \DIFaddFL{45.23 }\\
\DIFaddFL{VCC (Google)              }& \DIFaddFL{0.00 }& \DIFaddFL{0.00 }& \DIFaddFL{0.00  }& \DIFaddFL{0.00  }& \DIFaddFL{0.00  }& \DIFaddFL{0.00 }\\
\DIFaddFL{\textbf{CA-WOA}           }& \DIFaddFL{\textbf{0.00} }& \DIFaddFL{\textbf{0.00} }& \DIFaddFL{\textbf{0.00} }& \DIFaddFL{\textbf{0.00} }& \DIFaddFL{\textbf{0.00} }& \DIFaddFL{\textbf{0.00} }\\
\bottomrule
\end{tabular}
\end{table}

\DIFadd{Among feasible schedules CA-WOA is best in 9 of 12 configurations. It is beaten by GA in three cells, all at
$M=10$ with $N\ge1500$, by 0.08 }\DIFaddend to \DIFdelbegin \DIFdel{59\%, and PSO from about 13\% to 41\% }\DIFdelend \DIFaddbegin \DIFadd{0.15 percentage points---reported here rather than omitted. Its variance is
...
carbon-aware scheduler }\cite{radovanovic2023carbon}\DIFadd{, which throttles per-slot capacity as a function of carbon
intensity; and threshold-based temporal shifting }\cite{wiesner2021lets}\DIFadd{. VCC's throttle floor was swept over
...
\begin{table}[H]\centering\footnotesize
\caption{\DIFaddFL{Ablation at 3000 tasks, $M=10$, published model, 30 seeds. Removing a fitness term raises carbon
...
\begin{tabular}{lrrr}
\toprule
\DIFaddFL{Variant }& \DIFaddFL{Carbon red.\% }& \DIFaddFL{SLA\% }& \DIFaddFL{Overload\% }\\ \midrule
\DIFaddFL{Greedy only (no search)              }& \DIFaddFL{89.40 }& \DIFaddFL{0.00  }& \DIFaddFL{45.23 }\\
\DIFaddFL{Standard WOA (random init)           }& \DIFaddFL{87.15 }& \DIFaddFL{0.57  }& \DIFaddFL{0.58 }\\
\DIFaddFL{WOA + improved init (no carbon data) }& \DIFaddFL{87.17 }& \DIFaddFL{0.41  }& \DIFaddFL{0.50 }\\
\DIFaddFL{\textbf{CA-WOA (carbon seeding)}     }& \DIFaddFL{\textbf{87.58} }& \DIFaddFL{\textbf{0.13} }& \DIFaddFL{\textbf{0.03} }\\
\DIFaddFL{CA-WOA, $\beta=0$ (no SLA term)      }& \DIFaddFL{88.39 }& \DIFaddFL{37.53 }& \DIFaddFL{0.00 }\\
\DIFaddFL{CA-WOA}\DIFaddendFL , \DIFdelbeginFL \DIFdelFL{so the methods that superficially match CA-WOA on carbon
become progressively less viable.
This shows that }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{$\gamma=0$ (no overload term)}& \DIFaddFL{89.41 }& \DIFaddFL{0.00  }& \DIFaddFL{45.05 }\\
\bottomrule
\end{tabular}
\end{table}
...
\DIFaddend CA-WOA \DIFdelbegin \DIFdel{'s reliability is preserved as the workload grows, which is the property a production scheduler requires}\DIFdelend \DIFaddbegin \DIFadd{ranks first in all six configurations under each of the linear, cubic and piecewise power models---18 of
...
fitting a trend to them}\DIFaddend .
\begin{figure}[H]\centering
\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=\linewidth]{fig_scalability.png}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=0.86\linewidth]{fig_regions.png}
\DIFaddendFL \caption{\DIFdelbeginFL \DIFdelFL{Scalability: carbon reduction }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Seeding gain }\DIFaddendFL (\DIFdelbeginFL \DIFdelFL{left}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{CA-WOA minus standard WOA}\DIFaddendFL ) \DIFdelbeginFL \DIFdelFL{and SLA violations (right) versus task count (50--300)}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{against grid carbon variability}\DIFaddendFL , \DIFdelbeginFL \DIFdelFL{mean over }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{1500 tasks, six real
three-day windows per region, error bars 95\% confidence intervals. All }\DIFaddendFL five \DIFdelbeginFL \DIFdelFL{seeds}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{gains are positive, but the
near-flat Mid-Atlantic grid gains least and is the configuration in which CA-WOA is beaten by the best
competing method}\DIFaddendFL .}\DIFdelbeginFL %DIFDELCMD < \label{fig:scale}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \label{fig:regions}
\DIFaddendFL \end{figure}

\DIFaddbegin \subsection{\DIFadd{Computational cost and convergence}}\label{sec:cost}
...
\caption{\DIFaddFL{Convergence at 3000 tasks on 10 hosts, 10 seeds, shaded band one standard deviation. Carbon-aware
...
\DIFaddend \subsection{Forecasting}
...
}\DIFaddend of roughly 12\% \DIFaddbegin \DIFadd{is therefore withdrawn}\DIFaddend ,
...
}\DIFdelend \cite{wiesner2021lets} and of consolidation \DIFdelbegin \DIFdel{established by Beloglazov et al. }\DIFdelend \cite{beloglazov2012energy} \DIFdelbegin \DIFdel{, but
show that }\DIFdelend \DIFaddbegin \DIFadd{and show }\DIFaddend the two are
...
CarbonCast }%DIFDELCMD < \cite{maji2022carboncast}%%%
\DIFdel{.
...
production scheduler }\cite{radovanovic2023carbon} \DIFadd{the proposed method wins in every configuration tested,
...
\DIFadd{All data are public. Workload traces: Google Cluster Trace 2011 }\cite{reiss2011google} \DIFadd{and the NASA-iPSC log
